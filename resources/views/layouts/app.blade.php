            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="/"><img src="{{ asset('assets/imgs/logo/logo2.png')}}" alt="logo2"></a>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Call Free</span><a href="+420 000 000 001 ">+420 000 000 001 </a></p>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Václavské náměstí 6
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+420 000 001
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@practiceshop.cz
                            </p>
